        ...
        try {      
          ...
          await WebDevServices.create({First_Name,Last_Name,Phone_Number,Email})
                          .then(async (data) => {
                                                 ...
                                                 await sendEmailToCustomer(host, data.Email, "NA",3, emailConstants.RequestForWebsiteDevelopment, emailConstants.htmlcontent_WEBSITEDEVELOPMENTSERVICES, data.First_Name);
